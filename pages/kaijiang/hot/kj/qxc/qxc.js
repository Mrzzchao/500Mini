...
Page({
  ...
  getHistory:function(){
      var _this = this;
      app.getOpenHistory(4,function(data){
           _this.setData({historyList:data.data});
      })
  },
  getOpenInfo:function(){
    var _this = this;
    app.getOpenInfo(4,function(data){
  ...
  getPrizeDetail:function(){
      var _this = this;
    app.getPrizeDetail(4,this.data.expect,function(data){
            if(data.data&&data.data.OutBall){
               data.data['fore'] = data.data.OutBall.split(',');
             }       
