...
Page({
  ...
  getHistory:function(){
      var _this = this;
      app.getOpenHistory(10001,function(data){
           _this.setData({historyList:data.data});
      })
  },
  getOpenInfo:function(){
    var _this = this;
    app.getOpenInfo(10001,function(data){
  ...
  getPrizeDetail:function(){
      var _this = this;
    app.getPrizeDetail(10001,this.data.expect,function(data){
            if(data.data&&data.data.result){
               data.data['fore'] = data.data.result.split(',');
             }       
